...
import {Icon ,Input, Button ,Tooltip, Modal ,Pagination ,message ,notification} from 'antd';
...
export default class Operating extends Component{
    ...
    render(){
        const {confirmLoading, showFormModal} =this.state;
        return(
            <div className='displayFlex operating'>
                ...
                showTotal={total => `共 ${total} 条`} onChange={this.onChange}  
                defaultCurrent={1} total={this.props.lists.length} />
            </div>
        )
    }
}